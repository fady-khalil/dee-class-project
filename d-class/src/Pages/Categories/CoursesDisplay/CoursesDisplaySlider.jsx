...
const CoursesDisplay = ({
  ...
  return (
    ...
    >
      <Container>
        <h1 className="text-2xl sm:text-3xl xxl:text-4xl text-white font-bold mb-5 sm:mb-10">
          {courses?.name}
        </h1>
        <div
          className={`text-white grid grid-cols-1 md:grid-cols-2  xxl:grid-cols-3 gap-x-8 gap-y-24`}
        >
            ...
            >
              ...
              <div className="relative overflow-hidden rounded-lg">
                <img
                  ...
                  className="rounded-lg h-[160px] sm:h-[180px] md:h-[200px] lg:h-[260px] w-full object-cover transition-transform duration-300 hover:scale-105 "
                  alt={course.name}
                  loading="lazy"
                />
              </div>
