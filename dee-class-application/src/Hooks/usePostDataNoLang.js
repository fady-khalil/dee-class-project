...
/**
 * Hook for making POST requests without language in the URL
 * @returns {Object} Object containing data, loading state, error state, and post function
 */
const usePostDataNoLang = () => {
  ...
  const postData = async (url, dataToPost, token = null) => {
    const headers = {
